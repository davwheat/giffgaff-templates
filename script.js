...
When you get a response, you will receive a text and email alert telling you. You can view the response either from the bottom of your giffgaff dashboard, or by clicking this link: https://giffgaff.com/support/questions`
	},
	{
...
1. Please go to this URL: https://giffgaff.com/support/lost
...
If you find your phone again, you'll need to contact a giffgaff agent to get the device bar removed here (it can take a few days): https://support2.giffgaff.com/app/ask/Phones/Place-or-remove-an-IMEI-bar/form`
	},
	{
		title: "SIM Swap",
		addFooter: true,
...
See this guide for more info: https://giffgaff.com/support/sim-and-number/change-your-sim`
	},
	{
		title: "Return Phone",
		addFooter: true,
...
1. Change the password to your giffgaff account - [https://giffgaff.com/profile/details#passwd](https://giffgaff.com/profile/details#passwd)

2. Verify all your account details are correct: [https://giffgaff.com/profile/details](https://giffgaff.com/profile/details)

3. Let giffgaff know about the possible account compromise via the agents on this link so they can advise you on what to do next (and state if you received a text saying a SIM Swap is about to be performed) - [https://support2.giffgaff.com/app/ask/Account-misuse/Account-Misuse/form/](https://support2.giffgaff.com/app/ask/Account-misuse/Account-Misuse/form/)
...
A giffgaff educator has been alerted to the scam and they will contact you shortly via a private message: [https://community.giffgaff.com/t5/notes/privatenotespage](https://community.giffgaff.com/t5/notes/privatenotespage)
...
Just head to this page: https://giffgaff.com/profile/details/getnumber
...
When you get a response (usually within 1-2 hours, but can be up to 24 hours), you should receive a text and email alert telling you. You can view the response either from the bottom of your giffgaff dashboard, or by clicking this link: https://giffgaff.com/support/questions

If they can't cancel your order, you will have to return it when it arrives.

To see how to return your phone, see this link: https://community.giffgaff.com/t5/Solve-your-questions/How-to-return-a-faulty-phone-within-the-first-30-days-of-receipt/ta-p/17284481`
	},
	{
...
If you do want to leave, you can get your PAC code, text "PAC" to 65075. You'll get your PAC within a minute or two. (You can learn more about Text-to-Switch here: https://www.ofcom.org.uk/about-ofcom/latest/media/media-releases/2019/end-it-with-a-text-mobile-switching)

You can also dial 43431 (pen and paper in hand!) and follow the prompts to get your PAC code.

Both of these are completely free but will only work in the UK.

You can get your PAC online as well: https://giffgaff.com/profile/details/requestpac
...
An affiliate SIM means a SIM ordered by you through your ['share the love'](https://giffgaff.com/orders/mgm) page or a SIM ordered by someone else via your affiliate link.
...
You can redeem these as credit, donate them to charity or get them paid to PayPal (if you have 1000 or more) every 6 months (June and December).`
	},
	{
		...
		addFooter: true,
		content: `There isn't a way to do this at the moment on giffgaff. There is a [member suggested idea](https://labs.giffgaff.com/idea/4660/handling-multiple-sims-from-a-single-companyfamily-account) on giffgaff Labs that is being "looked into", though. You should vote on that if you think it's a good idea.
...
You can [order another free SIM](https://giffgaff.com/orders/affiliate/mrjeeves) and activate it on your giffgaff account if you want to use giffgaff again.`
	},
	{
...
Head to the [password reset page](https://giffgaff.com/support/lost-password) and choose either **email** or **text**.
...
1. Download [Google Messages](https://play.google.com/store/apps/details?id=com.google.android.apps.messaging&hl=en) on your Android phone
...
Please note that the Always On (£25) and £20 goodybags will be limited to 20 GB data when roaming in the EU, instead of the "normal" (technically a special offer) 40 GB. This is detailed when you are buying a goodybag, as well as on the [goodybags page](https://www.giffgaff.com/sim-only-plans) (under [color=#074984]**More info**[/color] on the applicable goodybags). After the 20 GB is up, you'll be charged 0.46p/MB.
